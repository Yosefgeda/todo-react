...
To clone: git clone git@github.com:Yosefgeda/todo-react.git
to change to directory: cd todo-react
...
Feel free to check the [issue page](https://github.com/Yosefgeda/todo-react/issues)
...
And the writer of the tutorial [Ibas Majeed](https://twitter.com/ibaslogic )
